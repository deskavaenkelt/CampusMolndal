...
public class Menu {
    ...
    static void loggedIn_User() throws Exception {
    ...
    static void loggedIn_User_switch(int userInput) throws Exception {
        switch (userInput) {
            case 1:
    ...
    static void loggedIn_Admin() throws Exception {
        while (Main.isLoggedIn) {
            View.loggedIn_Admin();
    ...
    static void loggedIn_Admin_switch(int userInput) throws Exception {
        switch (userInput) {
            case 1:
                Controller.printSaldo();
                break;
