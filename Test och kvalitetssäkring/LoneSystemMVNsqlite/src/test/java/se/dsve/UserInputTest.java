...
import se.dsve.controller.UserInput;
...
//    fail(TEST_NOT_WRITTEN);
    ...
    void isInteger_ToBigInt() {
        ...
        assertFalse(UserInput.isIntegerTest(input + "1"));
    }
    ...
    // readDoubleTestAble
    @Test
    void readDoubleTestAble_String_1() {
        assertEquals(-1, UserInput.readDoubleTestAble("A regular string"));
    }

    @Test
    void readDoubleTestAble_String_2() {
        assertEquals(-1, UserInput.readDoubleTestAble("01Adam"));
    }

    @Test
    void readDoubleTestAble_String_3() {
        assertEquals(-1, UserInput.readDoubleTestAble("Adam01"));
    }

    @Test
    void readDoubleTestAble_Double() {
        assertEquals(365.024, UserInput.readDoubleTestAble("365.024"));
    }

    @Test
    void readDoubleTestAble_Int() {
        assertEquals(365, UserInput.readDoubleTestAble("365"));
    }
